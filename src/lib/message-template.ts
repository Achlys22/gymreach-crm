...
function buildOffer(seed: number): string {
  const offers: string[] = [
    "I run Google Ads for martial arts gyms in the UK — I'll run your first month free, you only cover ad spend (~£150-300), no management fee, no contract.",
    ...
    "Quick context: I run Google Ads for MMA/Muay Thai/boxing gyms across the UK. First month free, you only pay the ad spend (~£150-300), no contract, no management fee.",
    "I help UK martial arts gyms get more members through Google Ads. First month free — you cover ad spend only (~£150-300), no management fee, cancel anytime.",
    "I run Google Ads specifically for martial arts gyms. Happy to run your first month free — you cover the ad spend (~£150-300), no management fee, no contract to sign.",
  ];
